...
void goControlsMenu(void (*returnTo)()) {
    ...
    DMANow(3, controls_menu_ssPal, SPRITEPALETTE, controls_menu_ssPalLen/2);
    DMANow(3, controls_menu_ssTiles, &CHARBLOCK[4], controls_menu_ssTilesLen/2);

    //Draw Controls Title
    shadowOAM[0].attr0 = ATTR0_4BPP | ATTR0_WIDE | (4 & 0xFF);
    shadowOAM[0].attr1 = ATTR1_LARGE | (70 & 0x1FF);
    shadowOAM[0].attr2 = OFFSET(0,0,32);
    // shadowOAM[1].attr0 = ATTR0_4BPP | ATTR0_WIDE | (4 & 0xFF);
    // shadowOAM[1].attr1 = ATTR1_LARGE | (148 & 0x1FF);
    shadowOAM[1].attr0 = ATTR0_4BPP | (4 & 0xFF);
    shadowOAM[1].attr1 = ATTR1_MEDIUM | (134 & 0x1FF);
