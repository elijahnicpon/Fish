...
# 6 "death_plastic.c" 2
# 1 "death_plastic_ss.h" 1
# 21 "death_plastic_ss.h"
extern const unsigned short death_plastic_ssTiles[16384];


extern const unsigned short death_plastic_ssPal[256];
# 7 "death_plastic.c" 2
...
void goDeathPlastic() {
    ...
    DMANow(3, death_plastic_ssPal, ((unsigned short *)0x5000200), 512/2);
    DMANow(3, death_plastic_ssTiles, &((charblock *)0x6000000)[4], 32768/2);
