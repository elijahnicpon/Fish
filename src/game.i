...
# 22 "game_clouds_bg.h"
extern const unsigned short game_clouds_bgTiles[816];


extern const unsigned short game_clouds_bgMap[1024];


extern const unsigned short game_clouds_bgPal[256];
# 8 "game.c" 2
# 1 "game_clouds_SHADOW_bg.h" 1
# 22 "game_clouds_SHADOW_bg.h"
extern const unsigned short game_clouds_SHADOW_bgTiles[1024];


extern const unsigned short game_clouds_SHADOW_bgMap[1024];
...
void initEnergyBar() {
    for (int i = 0; i < 28; i++) {
        shadowOAM[30 + i].attr0 = (0 << 13) | (0 << 14) | (2 & 0xFF);
        shadowOAM[30 + i].attr1 = (0 << 14) | ((9 + i * 2) & 0x1FF);
        shadowOAM[30 + i].attr2 = ((4) * (32) + (8));
    }
}

void doShieldDisplay() {
    shadowOAM[29].attr0 = (0 << 13) | (0 << 14) | (11 & 0xFF);
    shadowOAM[29].attr1 = (0 << 14) | (59 & 0xFF);
    shadowOAM[29].attr2 = ((3) * (32) + (player.shieldsLeft));
}

void doShellDisplay() {
    shadowOAM[25].attr0 = (0 << 13) | (0 << 14) | (11 & 0xFF);
    shadowOAM[25].attr1 = (0 << 14) | (37 & 0x1FF);
    shadowOAM[25].attr2 = ((3) * (32) + (shells_owned % 10));

    shadowOAM[26].attr0 = (0 << 13) | (0 << 14) | (11 & 0xFF);
    shadowOAM[26].attr1 = (0 << 14) | (30 & 0x1FF);
    shadowOAM[26].attr2 = ((3) * (32) + ((shells_owned / 10) % 10));

    shadowOAM[27].attr0 = (0 << 13) | (0 << 14) | (11 & 0xFF);
    shadowOAM[27].attr1 = (0 << 14) | (23 & 0x1FF);
    shadowOAM[27].attr2 = ((3) * (32) + ((shells_owned / 100) % 10));

    shadowOAM[28].attr0 = (0 << 13) | (0 << 14) | (11 & 0xFF);
    shadowOAM[28].attr1 = (0 << 14) | (16 & 0x1FF);
    shadowOAM[28].attr2 = ((3) * (32) + (shells_owned / 1000));
}
...
void updateAndDrawShells() {
    ...
    for (int i = 0; i < NUM_SHELLS; i++) {
        if (shells[i].active) {
            ...
            shadowOAM[shells[i].entry_OAM].attr0 = (2 << 8);
        }
    }
}
        ...
        if (!shells[i].active) {
            ...
            switch (shells[i].value) {
                case 1:
                    ...
                    break;
                case 2:
                    shells[i].paletteIndex = 1;
                    break;
                case 4:
                    shells[i].paletteIndex = 2;
                    break;
                case 8:
...
void toggleCloudsOff() {
    ...
    for (int i = 0; i < 1024; i++) {
        ...
        ((screenblock *)0x6000000)[30].tilemap[i] = 0;
    }
}
...
# 306 "game.c"
    ...
    shadowOAM[player.entry_OAM].attr2 = playerFrames[player.frame] | ((1)<<10);
