...
# 6 "controls_menu.c" 2
# 1 "controls_menu_ss.h" 1
# 21 "controls_menu_ss.h"
extern const unsigned short controls_menu_ssTiles[16384];


extern const unsigned short controls_menu_ssPal[256];
# 7 "controls_menu.c" 2
...
void goControlsMenu(void (*returnTo)()) {
    ...
    DMANow(3, controls_menu_ssPal, ((unsigned short *)0x5000200), 512/2);
    DMANow(3, controls_menu_ssTiles, &((charblock *)0x6000000)[4], 32768/2);
    ...
    shadowOAM[1].attr0 = (0 << 13) | (4 & 0xFF);
    shadowOAM[1].attr1 = (2 << 14) | (134 & 0x1FF);
