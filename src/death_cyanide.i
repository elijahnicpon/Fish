...
# 6 "death_cyanide.c" 2
# 1 "death_cyanide_ss.h" 1
# 21 "death_cyanide_ss.h"
extern const unsigned short death_cyanide_ssTiles[16384];


extern const unsigned short death_cyanide_ssPal[256];
# 7 "death_cyanide.c" 2
...
void goDeathCyanide() {
    ...
    DMANow(3, death_cyanide_ssPal, ((unsigned short *)0x5000200), 512/2);
    DMANow(3, death_cyanide_ssTiles, &((charblock *)0x6000000)[4], 32768/2);
