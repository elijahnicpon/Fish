...
void goDeathShark() {
    ...
    DMANow(3, death_shark_ssPal, SPRITEPALETTE, death_shark_ssPalLen/2);
    DMANow(3, death_shark_ssTiles, &CHARBLOCK[4], death_shark_ssTilesLen/2);
