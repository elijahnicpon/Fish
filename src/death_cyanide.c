...
void goDeathCyanide() {
    ...
    DMANow(3, death_cyanide_ssPal, SPRITEPALETTE, death_cyanide_ssPalLen/2);
    DMANow(3, death_cyanide_ssTiles, &CHARBLOCK[4], death_cyanide_ssTilesLen/2);
