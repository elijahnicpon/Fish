...
# 1 "death_oil_ss.h" 1
# 21 "death_oil_ss.h"
extern const unsigned short death_oil_ssTiles[16384];


extern const unsigned short death_oil_ssPal[256];
# 7 "death_oil.c" 2
...
void goDeathOil() {
    ...
    DMANow(3, death_oil_ssPal, ((unsigned short *)0x5000200), 512/2);
    DMANow(3, death_oil_ssTiles, &((charblock *)0x6000000)[4], 32768/2);
