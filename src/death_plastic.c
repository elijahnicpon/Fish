...
void goDeathPlastic() {
    ...
    DMANow(3, death_plastic_ssPal, SPRITEPALETTE, death_plastic_ssPalLen/2);
    DMANow(3, death_plastic_ssTiles, &CHARBLOCK[4], death_plastic_ssTilesLen/2);
