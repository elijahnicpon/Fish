...
void goDeathDynamite() {
    ...
    DMANow(3, death_dynamite_ssPal, SPRITEPALETTE, death_dynamite_ssPalLen/2);
    DMANow(3, death_dynamite_ssTiles, &CHARBLOCK[4], death_dynamite_ssTilesLen/2);
