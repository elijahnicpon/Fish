...
# 6 "death_dynamite.c" 2
# 1 "death_dynamite_ss.h" 1
# 21 "death_dynamite_ss.h"
extern const unsigned short death_dynamite_ssTiles[16384];


extern const unsigned short death_dynamite_ssPal[256];
# 7 "death_dynamite.c" 2
...
void goDeathDynamite() {
    ...
    DMANow(3, death_dynamite_ssPal, ((unsigned short *)0x5000200), 512/2);
    DMANow(3, death_dynamite_ssTiles, &((charblock *)0x6000000)[4], 32768/2);
