...
void goDeathEnergy() {
    ...
    DMANow(3, death_energy_ssPal, SPRITEPALETTE, death_energy_ssPalLen/2);
    DMANow(3, death_energy_ssTiles, &CHARBLOCK[4], death_energy_ssTilesLen/2);
